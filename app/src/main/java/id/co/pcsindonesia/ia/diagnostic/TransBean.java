...
public class TransBean implements Parcelable {
	...
	public static Creator<TransBean> CREATOR = new Creator<TransBean>(){
		...
		@Override
		public id.co.pcsindonesia.ia.diagnostic.TransBean createFromParcel(Parcel source) {
			return new id.co.pcsindonesia.ia.diagnostic.TransBean(source);
		}

		@Override
		public id.co.pcsindonesia.ia.diagnostic.TransBean[] newArray(int size) {
			return new id.co.pcsindonesia.ia.diagnostic.TransBean[size];
		}		
	};
